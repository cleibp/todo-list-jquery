<h1 align="center"> 🚀 TODO LIST | JQUERY </h1>

## ✍️ Descrição
Exemplificação de TODO LIST usando biblioteca jquery
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/todo-list-jquery.git
    ```
1. Download:
    ### Download Manual
...
[Publicação em Codepen](https://codepen.io/cleibp/pen/qBLZrVa) 
